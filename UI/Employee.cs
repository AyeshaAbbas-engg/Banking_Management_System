...
namespace WindowsFormsApp1.UI
{
    public partial class Employee : Form
    {
        ...
        {
            string query = $"SELECT EmployeeID, Employee.Name, Employee.Email, Employee.Phone, Branch.BranchName FROM Employee JOIN Branch ON Employee.BranchID = Branch.BranchID WHERE Employee.Status = 'Active';\r\n";
